    ...
    public static class CMDebug
    {
        ...
        public static void TextPopupMouse(string text, Vector3? offset = null)
        {
            ...
            UtilsClass.CreateWorldTextPopup(
                text,
                UtilsClass.GetMouseWorldPosition() + (Vector3)offset
            );
        }
        ...
        {
            return UtilsClass.CreateWorldTextUpdater(
                GetTextFunc,
                localPosition,
                parent,
                fontSize,
        ...
        public static void MouseTextUpdater(
            Func<string> GetTextFunc,
        ...
        public static GameObject DrawSpriteTimed(
            Vector3 position,
            Sprite sprite,
            float scale,
            float timer
        ...
        public static GameObject DrawSpriteTimedAlpha(
            Sprite sprite,
            float scale,
            float timer,
