            ...
            IPointerUpHandler
    {
...
#if SOUND_MANAGER
        public Sound_Manager.Sound mouseOverSound,
            mouseClickSound;
#endif
#if CURSOR_MANAGER
        public CursorManager.CursorType cursorMouseOver,
            cursorMouseOut;
#endif
        ...
        public virtual void OnPointerEnter(PointerEventData eventData)
        {
            ...
            if (hoverBehaviour_Move)
                transform.GetComponent<RectTransform>().anchoredPosition = posEnter;
        ...
        public virtual void OnPointerExit(PointerEventData eventData)
        {
            ...
            if (hoverBehaviour_Move)
                transform.GetComponent<RectTransform>().anchoredPosition = posExit;
        ...
        private void Awake()
        {
            ...
            internalOnPointerEnterFunc += () =>
            {
                if (mouseOverSound != Sound_Manager.Sound.None)
                    Sound_Manager.PlaySound(mouseOverSound);
            };
            internalOnPointerClickFunc += () =>
            {
                if (mouseClickSound != Sound_Manager.Sound.None)
            ...
            internalOnPointerEnterFunc += () =>
            {
                if (cursorMouseOver != CursorManager.CursorType.None)
                    CursorManager.SetCursor(cursorMouseOver);
            };
            internalOnPointerExitFunc += () =>
            {
                if (cursorMouseOut != CursorManager.CursorType.None)
        ...
        public void SetHoverBehaviourType(HoverBehaviour hoverBehaviourType)
        {
            ...
            switch (hoverBehaviourType)
            {
                ...
                case HoverBehaviour.Change_Color_Auto:
                    ...
                    hoverBehaviourFunc_Enter = delegate()
                    {
                        hoverBehaviour_Image.color = colorOver;
                    };
                    hoverBehaviourFunc_Exit = delegate()
                    {
                        hoverBehaviour_Image.color = color;
                    };
                    break;
            }
        }
        ...
        public InterceptActionHandler InterceptAction(
            string fieldName,
        ...
        )
        {
            ...
            InterceptActionHandler interceptActionHandler = new InterceptActionHandler(
                () => fieldInfo.SetValue(this, backFunc)
            );
            fieldInfo.SetValue(
                this,
                (Action)
