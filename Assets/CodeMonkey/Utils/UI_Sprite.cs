...
namespace CodeMonkey.Utils
{
    ...
    public class UI_Sprite
    {
        ...
        {
            UI_Sprite uiSprite = new UI_Sprite(
                GetCanvasTransform(),
                Assets.i.s_White,
                anchoredPosition,
                size,
        ...
        )
        {
            ...
            UI_Sprite uiSprite = CreateDebugButton(
                parent,
                anchoredPosition,
                Vector2.zero,
                ClickFunc,
            ...
            uiSprite.SetSize(
                new Vector2(uiTextComplex.GetTotalWidth(), uiTextComplex.GetTotalHeight()) + padding
            );
            return uiSprite;
        }
        ...
        )
        {
            ...
            uiSprite.AddButton(
                ClickFunc,
                () => uiSprite.SetColor(colorOver),
                () => uiSprite.SetColor(color)
            );
            uiTextComplex = new UI_TextComplex(
                uiSprite.gameObject.transform,
                Vector2.zero,
                12,
                '#',
                text,
        ...
        {
            rectTransform = UtilsClass.DrawSprite(
                sprite,
                parent,
                anchoredPosition,
                size,
