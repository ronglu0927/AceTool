...
namespace CodeMonkey.Utils
{
    ...
    public static class UtilsClass
    {
        ...
        // 获取排序顺序以设置SpriteRenderer排序顺序，较高的位置=较低的排序顺序
        ...
        public static string GetMilliDots(long n)
        {
            ...
            {
                ret =
                    ret.Substring(0, ret.Length - i * 3 - (i - 1))
                    + "."
        ...
        public static bool IsPositionInsideFov(
            Vector3 pos,
            Vector3 aimDir,
            Vector3 posTarget,
            float fov
        ...
        public static void ReplaceColorArrays(
            Color[] baseArray,
            Color[] replaceArray,
            Color ignoreColor
        )
        ...
        public static void TintColorArrayInsideMask(Color[] baseArray, Color tint, Color[] mask)
        {
            for (int i = 0; i < baseArray.Length; i++)
            {
                if (mask[i].a > 0)
                {
                    ...
                    baseArray[i].r =
                        baseColor.r + (fullyTintedColor.r - baseColor.r) * interpolateAmount;
                    baseArray[i].g =
                        baseColor.g + (fullyTintedColor.g - baseColor.g) * interpolateAmount;
                    baseArray[i].b =
                        baseColor.b + (fullyTintedColor.b - baseColor.b) * interpolateAmount;
                }
            }
        }
        ...
        public static Vector3 GetRandomPositionWithinRectangle(
            float xMin,
            float xMax,
            float yMin,
            float yMax
        ...
        public static void GetTimeCharacterStrings(
            float time,
            out string h0,
            out string h1,
            out string m0,
        ...
        )
        {
            ...
            {
                List<Vector3> ringPositionList = GetPositionListAround(
                    position,
                    ringDistance[ring],
                    ringPositionCount[ring]
                );
        ...
        public static List<Vector3> GetPositionListAlongAxis(
        ...
        )
        {
            ...
            return GetPositionListAlongDirection(
                positionStart + direction * (distancePerPosition / 2f),
                direction,
                distancePerPosition,
                positionCount
            );
        ...
        public static List<Vector3> GetPositionListWithinRect(
            Vector3 lowerLeft,
            Vector3 upperRight,
            int positionCount
        )
        ...
        public static List<Vector2Int> GetPosXYListOblong(
            int width,
            int dropXamount,
            int increaseDropXamount,
            Vector3 dir
        )
        {
        ...
        {
            List<Vector2Int> triangle = GetPosXYListTriangle(
                width,
                dropXamount,
                increaseDropXamount
            );
        ...
        public static List<Vector2Int> GetPosXYListTriangle(
            int width,
            int dropXamount,
            int increaseDropXamount
        )
        ...
        public static List<Vector2Int> RotatePosXYList(List<Vector2Int> list, int angle)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                Vector3 vec = UtilsClass.ApplyRotationToVector(
                    new Vector3(posXY.x, posXY.y),
                    angle
                );
        ...
        )
        {
            for (int i = 0; i <= divisions; i++)
            {
                Vector3 vec1 =
                    center
                    + UtilsClass.ApplyRotationToVector(
                        new Vector3(0, 1) * radius,
                        (360f / divisions) * i
                    );
                Vector3 vec2 =
                    center
        ...
        {
            Debug.DrawLine(
                new Vector3(minXY.x, minXY.y),
                new Vector3(maxXY.x, minXY.y),
                color,
                duration
            );
            Debug.DrawLine(
                new Vector3(minXY.x, minXY.y),
                new Vector3(minXY.x, maxXY.y),
                color,
                duration
            );
            Debug.DrawLine(
                new Vector3(minXY.x, maxXY.y),
                new Vector3(maxXY.x, maxXY.y),
                color,
                duration
            );
            Debug.DrawLine(
            ...
            switch (c)
            {
                ...
                case 'I':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.487f, 0.906f, 0.484f, 0.096f }
                    );
                    break;
                case 'J':
                    DebugDrawLines(
                ...
                case 'L':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.311f, 0.879f, 0.308f, 0.133f, 0.682f, 0.148f }
                    );
                    break;
                case 'M':
                    DebugDrawLines(
                ...
                case 'N':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.737f, 0.885f, 0.679f, 0.114f, 0.335f, 0.845f, 0.353f, 0.175f }
                    );
                    break;
                case 'O':
                    DebugDrawLines(
                ...
                case 'T':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.497f, 0.172f, 0.5f, 0.864f, 0.286f, 0.858f, 0.719f, 0.852f }
                    );
                    break;
                case 'U':
                    DebugDrawLines(
                ...
                case 'V':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.238f, 0.855f, 0.494f, 0.105f, 0.707f, 0.855f }
                    );
                    break;
                case 'X':
                    DebugDrawLines(
                ...
                case 'Z':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.25f, 0.87f, 0.795f, 0.842f, 0.274f, 0.133f, 0.716f, 0.142f }
                    );
                    break;
                ...
                case ',':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.533f, 0.239f, 0.527f, 0.154f, 0.487f, 0.099f, 0.451f, 0.062f }
                    );
                    break;
                case '_':
                    DebugDrawLines(
                        ...
                        size,
                        duration,
                        new[] { 0.274f, 0.133f, 0.716f, 0.142f }
                    );
                    break;
        ...
        public static class ReflectionTools
        {
            ...
            {
                System.Reflection.FieldInfo fieldInfo = System
            ...
            /// </summary>
            /// <param name="typeName"></param>
            /// <param name="nestedTypeName"></param>
            /// <returns></returns>
