...
namespace CodeMonkey.Utils
{
    ...
    public class World_Mesh
    {
        ...
        public static World_Mesh CreateEmpty(
            Vector3 position,
            float eulerZ,
            Material material,
        ...
        )
        {
            return Create(
                lowerLeftCorner,
                lowerLeftCorner + new Vector3(width, height),
                material,
                uvCoords,
                sortingOrderOffset
            );
        ...
        )
        {
            ...
            Vector2[] uvArray = GetUVRectangleFromPixels(
                uvCoords.x,
                uvCoords.y,
                uvCoords.width,
                uvCoords.height,
