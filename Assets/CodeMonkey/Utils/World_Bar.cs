...
namespace CodeMonkey.Utils
{
    ...
    public class World_Bar
    {
        ...
        public static World_Bar Create(
        ...
        public void SetLocalScale(Vector3 localScale)
        {
            ...
            {
                // Has outline
                transform.Find("Outline").localScale =
                    localScale + new Vector3(outline.size, outline.size);
            }
        ...
        public void SetSortingOrder(int sortingOrder)
        {
            ...
            if (background != null)
                background.GetComponent<SpriteRenderer>().sortingOrder = sortingOrder - 1;
            if (transform.Find("Outline") != null)
                transform.Find("Outline").GetComponent<SpriteRenderer>().sortingOrder =
                    sortingOrder - 2;
        }
        ...
        public void SetSortingLayerName(string sortingLayerName)
        {
            ...
            if (transform.Find("Outline") != null)
                transform.Find("Outline").GetComponent<SpriteRenderer>().sortingLayerName =
                    sortingLayerName;
        }
        ...
        public Button_Sprite AddButton(
            ...
            System.Action MouseOverOnceFunc,
